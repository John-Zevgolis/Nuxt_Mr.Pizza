  ...
  <main v-if="data" class="custom-padding-top pb-16 px-3">
    ...
    <div class="flex flex-wrap -mx-3">
      <div
        v-for="item in pizza"
        :key="item.id"
        class="w-full sm:w-1/2 lg:w-1/3 2xl:w-1/4 px-3 mt-6"
      >
...
const pizza = computed(() => data.value?.pizza || []);
